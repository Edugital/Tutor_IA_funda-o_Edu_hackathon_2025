...
$healthtable->data = [
    ...
    [get_string('processingtimeoutminutes', 'assignfeedback_aitutoria'), (string) $health['settings']['processingtimeoutminutes']],
    [get_string('institutionalframework', 'assignfeedback_aitutoria'), $health['framework']['configured'] ? (string) $health['framework']['version'] : get_string('notconfigured', 'assignfeedback_aitutoria')],
    [get_string('frameworkcompetencies', 'assignfeedback_aitutoria'), (string) $health['framework']['competencycount']],
    [get_string('productionproviders', 'assignfeedback_aitutoria'), empty($health['providers']) ? get_string('none', 'assignfeedback_aitutoria') : s(implode(', ', array_keys($health['providers'])))],
    [get_string('staleprocessingjobs', 'assignfeedback_aitutoria'), (string) $health['jobs']['staleprocessing']],
    [get_string('overduequeuedjobs', 'assignfeedback_aitutoria'), (string) $health['jobs']['overduequeued']],
];
...
$governancetable->data = [
    ...
    [get_string('totalcriteria', 'assignfeedback_aitutoria'), (string) $governance['criteria']['total']],

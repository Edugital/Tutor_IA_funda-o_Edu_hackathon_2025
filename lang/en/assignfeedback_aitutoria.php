...
$string['calibrationperiod7d'] = 'Last 7 days';
$string['calibrationperiod30d'] = 'Last 30 days';
$string['calibrationreport'] = 'AI tutoring calibration';
$string['calibrationreport_help'] = 'Rates among reviews that involved an AI suggestion (accepted, overridden/edited, rejected, or escalated). Human-in-Control policy is unchanged: nothing publishes without an explicit grader action.';
$string['calibrationreviews'] = 'Final human criterion selections';
$string['calibrationwindow'] = 'Window: {$a->from} → {$a->to}';
$string['count'] = 'Count';
...
$string['decision_accepted_ai'] = 'Accepted AI';
$string['decision_escalated'] = 'Escalated';
$string['decision_overridden_ai'] = 'Overridden / edited AI';
$string['decision_rejected_ai'] = 'Rejected AI';
...
$string['diffaisuggestion'] = 'AI suggestion';
$string['diffcompare'] = 'Compare suggestion and current feedback';
$string['diffcurrentempty'] = '(No published feedback yet — textarea below is empty.)';
$string['diffcurrentfeedback'] = 'Current feedback (form default)';
...
$string['reviewedwithai'] = 'Reviewed with AI';
$string['reviewaction'] = 'Decision about the AI suggestion';
$string['reviewaction_accept'] = 'Accept';
$string['reviewaction_escalate'] = 'Escalate';
$string['reviewaction_help'] = 'Choose an explicit action. Accept publishes the AI suggestion as feedback. Edit (manual) keeps your textarea. Discard rejects the suggestion. Escalate never publishes the AI text.';
$string['reviewaction_manual'] = 'Edit (manual)';
$string['reviewaction_reject'] = 'Discard';
...
$string['settings:policy'] = 'Human-in-Control policy';
$string['settings:policy_help'] = 'AI Tutoring never publishes feedback or changes numeric grades automatically. Keep “Enabled by default” and “Allow AI suggestions” off until an authorized provider and institutional acceptance exist. See INSTALL.md.';
$string['settings:providers'] = 'Assessment providers';
$string['settings:providers_help'] = 'Configure an authorized provider for unpublished advisory suggestions. API keys must never be committed to git. Prefer loading from a secured ops process.';
$string['defaultprovider'] = 'Default provider';
$string['defaultprovider_help'] = 'Provider used when queueing advisory assessments.';
$string['anthropicapikey'] = 'Anthropic API key';
$string['anthropicapikey_help'] = 'Claude API key for the EBAC pilot. Stored in Moodle config only.';
$string['anthropicmodel'] = 'Anthropic model';
$string['anthropicmodel_help'] = 'Model identifier, e.g. claude-sonnet-4-20250514.';
$string['glmapikey'] = 'GLM API key';
$string['glmapikey_help'] = 'Zhipu / Z.ai API key for the EBAC pilot. Stored in Moodle config only.';
$string['glmmodel'] = 'GLM model';
$string['glmmodel_help'] = 'Model identifier, e.g. glm-4-flash.';
$string['glmendpoint'] = 'GLM endpoint';
$string['glmendpoint_help'] = 'OpenAI-compatible chat completions URL.';
$string['openaiapikey'] = 'OpenAI API key';
$string['openaiapikey_help'] = 'OpenAI (or compatible) API key. Leave empty until production use is authorized. Never commit keys to git.';
$string['openaimodel'] = 'OpenAI model';
$string['openaimodel_help'] = 'Model identifier, e.g. gpt-4o-mini.';
$string['openaiendpoint'] = 'OpenAI endpoint';
$string['openaiendpoint_help'] = 'Chat completions URL (OpenAI or Azure-compatible).';
$string['missingglmkey'] = 'GLM API key is not configured.';
$string['glmemptysuggestion'] = 'GLM returned an empty suggestion.';
$string['glmbadcriteria'] = 'GLM returned invalid criteria payload.';
$string['glmmissingcriterion'] = 'GLM response missing criterion: {$a}';
$string['glmhttp'] = 'GLM HTTP error: {$a}';
$string['glmbadjson'] = 'GLM JSON parse error: {$a}';
$string['glmemptycontent'] = 'GLM returned empty content.';
$string['missinganthropickey'] = 'Anthropic API key is not configured.';
$string['anthropicemptysuggestion'] = 'Anthropic returned an empty suggestion.';
$string['anthropicbadcriteria'] = 'Anthropic returned invalid criteria payload.';
$string['anthropicmissingcriterion'] = 'Anthropic response missing criterion: {$a}';
$string['anthropichttp'] = 'Anthropic HTTP error: {$a}';
$string['anthropicbadjson'] = 'Anthropic JSON parse error: {$a}';
$string['anthropicemptycontent'] = 'Anthropic returned empty content.';
$string['missingopenaikey'] = 'OpenAI API key is not configured. Set assignfeedback_aitutoria/openaiapikey before using this provider.';
$string['openaistub'] = 'OpenAI provider is a stub in this release (model {$a}). Configure the API key and replace the stub assess() implementation before production use. Human-in-Control policy is unchanged.';
$string['pluginisdisabled'] = 'AI Tutoring feedback is disabled for this assignment.';
$string['submissionnotready'] = 'Student submission is not ready for assessment.';
$string['submissionempty'] = 'Student submission text is empty.';
$string['generatesuggestion'] = 'Generate AI suggestion';
$string['generatesuggestionbutton'] = 'Generate AI suggestion now';
$string['generatesuggestion_help'] = 'Runs the configured provider and stores an unpublished suggestion for human review. Does not change the numeric grade.';
$string['generatesuggestionconfirm'] = 'Generate an unpublished AI suggestion for this submission? The numeric grade will not change.';
$string['generatesuggestionsuccess'] = 'AI suggestion generated and stored for human review.';
$string['generatefailed'] = 'Could not generate AI suggestion: {$a}';
$string['requestaisuggestion'] = 'Also generate AI suggestion when saving';
$string['requestaisuggestion_help'] = 'If checked, saving this grade form queues and runs an advisory assessment before storing your human feedback.';
